...
function uploadImg(elForm, ev) {
    ...
    function onSuccess(uploadedImgUrl) {
        ...
        <a class="fb-btn2" href="www.facebook.com/sharer/sharer.php?u=${uploadedImgUrl}&t=${uploadedImgUrl}" title="Share on Facebook" target="_blank" onclick="window.open('www.facebook.com/sharer/sharer.php?u=${uploadedImgUrl}&t=${uploadedImgUrl}'); return false;">
...
function doUploadImg(elForm, onSuccess) {
    ...
    fetch('www.ca-upload.com/here/upload.php', {
            method: 'POST',
            body: formData
        })
        .then(function (res) {
